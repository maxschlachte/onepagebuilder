...
## Purpose
Remembers which top-level screen (the builder or the print view) and which list was open, restoring the user to that same place across a page reload instead of always resetting to the saved-lists screen.
