# game-system-switching Specification

## Purpose
Lets the user switch between the two supported rulesets — Warhammer 40k and Warhammer Fantasy — scoping the lists view and list-creation faction picker to the selected system, and resolving special-rule references against the correct system's own glossary.
...
#### Scenario: A Warhammer Fantasy unit's rules resolve against the Warhammer Fantasy glossary
